...
const AISuggestion = ({ onOpenSidebar }) => {
  ...
  const WelcomeDisplay = () => (
    <div className="welcome-container text-center p-6">
      ...
      <button
        ...
        disabled={isLoading}
        className="get-started-button flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 font-medium disabled:opacity-50"
      >
        <FontAwesomeIcon 
          icon={faPlay} 
  ...
  return (
    <div className='flex flex-col items-center p-4 md:p-8 ai-body min-h-screen flex-1 overflow-y-auto'>
      <button id='open-sidebar' className='absolute top-4 left-4 md:hidden mr-4 text-[#64748b] hover:text-[#334155] z-10' onClick={onOpenSidebar}>
        <HamburgerIcon />
      </button>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center mb-6'>
              ...
              <div className='suggestion-card glass rounded-2xl p-6 md:p-8 w-full max-w-2xl shadow-lg order-2 md:order-2'>
                {!hasInitialized ? (
                  ...
                  <blockquote className={`text-md md:text-lg text-gray-700 font-medium leading-relaxed transition-opacity duration-500 ${isLoadingNew ? 'opacity-50' : 'opacity-100'}`}>
                    "{currentSuggestion}"
                  </blockquote>
                )}
      ...
      {previousSuggestions.length > 0 && (
        <div className='w-full max-w-3xl mx-auto mt-auto'>
          ...
          <div className={`history-container transition-all duration-300 overflow-hidden ${
            ...
            <div className='relative timeline pl-8 mb-8'>
